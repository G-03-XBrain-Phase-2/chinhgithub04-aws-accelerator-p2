...
| | **Day B: Secrets & Supply Chain** | ![Hoàn thành](https://img.shields.io/badge/Hoàn_thành-brightgreen) | Tìm hiểu AWS Secrets Manager, External Secrets Operator (ESO), quét ảnh Trivy và ký ảnh Cosign | [Xem chi tiết](cloud/w10/day-b/theory/01_eso_secrets_rotation.md) |
| | **Day C: Platform Integration** | ![Hoàn thành](https://img.shields.io/badge/Hoàn_thành-brightgreen) | Tích hợp toàn bộ hệ thống, LimitRange, ResourceQuota, Chaos Engineering và viết Runbooks | [Xem chi tiết](cloud/w10/day-c/theory/01_resource_quota_limit_range.md) |
| | **Lab: Hardening & Enforcement** | ![Hoàn thành](https://img.shields.io/badge/Hoàn_thành-brightgreen) | Thực hành khắc phục 6 lỗ hổng bảo mật của cụm K8s và áp dụng chính sách Gatekeeper | [Xem chi tiết](cloud/w10/lab/README.md) |
| | **Reflection W10** | ![Hoàn thành](https://img.shields.io/badge/Hoàn_thành-brightgreen) | Nhật ký tự học và đánh giá phản hồi hàng ngày Tuần 10 | [Xem chi tiết](cloud/w10/reflection.md) |
