...
| | **Day B: Observability** | ![Lên kế hoạch](https://img.shields.io/badge/Lên_kế_hoạch-grey) | Tìm hiểu OTel, Prometheus, Grafana, Loki, thiết lập SLOs/SLIs và Multi-window burn rate alert | [Thư mục W9](cloud/w9/) |
